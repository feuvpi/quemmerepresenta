...
<div class="hero">
    ...
    <div class="bg-flag" aria-hidden="true">
        ...
        >
            ...
            <g mask="url(#flagMask)">
                <path
                    d="M 80,160 C 280,110 480,200 680,150 C 880,100 1080,200 1280,140 C 1380,110 1480,140 1520,150 L 1520,920 C 1380,970 1180,890 980,940 C 780,990 580,900 380,950 C 220,990 120,960 80,950 Z"
                    fill="#006B38"
                />
                <path
                    d="M 80,160 C 280,110 480,200 680,150 C 880,100 1080,200 1280,140 C 1380,110 1480,140 1520,150 L 1520,920 C 1380,970 1180,890 980,940 C 780,990 580,900 380,950 C 220,990 120,960 80,950 Z"
                ...
                />
                <path
                    d="M 600,545 C 700,510 900,510 1000,545"
                    fill="none"
                    stroke="#FFF"
                    stroke-opacity="0.85"
                    stroke-width="3"
    ...
    <main class="hero-main">
        ...
        <div class="hero-left">
            ...
            <div class="hero-glass anim-up-2">
                ...
                <div class="hero-ctas">
                    ...
                    <a href="/sobre" class="cta-secondary"> Como funciona </a>
                </div>
            </div>
        ...
        <div class="hero-right anim-up-2">
            <div class="stats-card">
                ...
                <div class="sc-grid">
                    {#each [["16", "Votações"], ["04", "Anos"], ["30+", "Partidos"], ["02", "Casas"]] as [n, l]}
                        <div class="sc-stat">
...
<style>
    ...
    .hero-glass {
        ...
        box-shadow:
            ...
            0 12px 40px rgba(17, 19, 16, 0.06);
        margin-bottom: 2rem;
    }
